    ...
    return (
        <div className="playlist">
            ...
            <div className="search-box">
                <input onChange={(e) => setSearch(e.target.value)} placeholder="Search Song, Artist"></input>
                <img height={19.33} width={19.33} style={{ opacity: "0.1" }} src={searchIcon} alt="search icon" />
            </div>
                    ...
                    responseData.map((item, index) => {
                        return (
                            <div
                                ...
                                style={{
                                    background: item === listDataInPlayer[curInd] ? "rgba(255, 255, 255, 0.08)" : "",
                                }}
                                key={item._id}
                                className="music-div"
                            >
